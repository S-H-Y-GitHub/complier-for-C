...
public class Translation
{
	...
	public void M5(Integer i) throws Exception
	{
		...
		interCode.add("MOV eax," + p2.getValue());
		switch (op.getValue())
		{
			case "+":
				interCode.add("ADD eax," + p1.getValue());
				break;
			case "-":
				interCode.add("SUB eax," + p1.getValue());
				break;
			case "*":
				interCode.add("IMUL " + p1.getValue());
				break;
			case "/":
				interCode.add("IDIV " + p1.getValue());
				break;
		}
		interCode.add("MOV " + temp + ",eax");
	}
	...
	public void $BOOL(Integer i)
	{
		...
		{
			case "==":
				interCode.add("CMP eax," + p1.getValue());
				interCode.add("MOV cx,zf");
				break;
			case "!=":
				interCode.add("CMP eax," + p1.getValue());
				interCode.add("MOV cx,zf");
